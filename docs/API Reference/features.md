...
- **properties**: JSON Schema {**label**: str|bytes, **description**: str|bytes, **style**: str|bytes, **location**: str|bytes, **timestamp**: str|bytes, **status**: str|bytes, **context**: str|bytes}

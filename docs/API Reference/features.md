...
- **properties**: JSON Schema {**location**: str|bytes, **style**: str|bytes, **status**: str|bytes, **timestamp**: str|bytes, **description**: str|bytes, **label**: str|bytes, **context**: str|bytes}

...
- **properties**: JSON Schema {**description**: str|bytes, **status**: str|bytes, **location**: str|bytes, **style**: str|bytes, **timestamp**: str|bytes, **context**: str|bytes, **label**: str|bytes}

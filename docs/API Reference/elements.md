...
- **element**: JSON Schema {**description**: str|bytes, **style**: str|bytes, **label**: str|bytes, **context**: str|bytes, **uuid**: str|bytes, **geom**: str|bytes, **status**: str|bytes, **prototype**: str|bytes}

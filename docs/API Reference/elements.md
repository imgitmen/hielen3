...
- **element**: JSON Schema {**geom**: str|bytes, **prototype**!: str|bytes, **label**: str|bytes, **style**: str|bytes, **context**: str|bytes, **uuid**!: str|bytes, **description**: str|bytes, **status**: str|bytes}

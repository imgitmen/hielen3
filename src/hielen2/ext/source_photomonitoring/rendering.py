...
from datamaps import agoodtime

class Render():

    def __init__(self,targetfile='./incomes/sag.nc', background=None, gridratio=8, **kwargs):
        self.dataset=xr.open_dataset(targetfile)
        self.baseimg=background
    ...
    # CLASS METHOD
    def _print_image(heatmap=None,vectors=None,colors=["green","red","blue"],vmin=0,vmax=5,baseimg=None,dims=None):
    ...
    def generate_map(self,timestamp=None, timeref=None, output="RV", background=False):

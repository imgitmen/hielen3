...
class GWO():
    ...
    def __init__(self,key=key,mac=GWOmac,wsdl='http://www.winecap.it/winecapws.wsdl'):
        self.key=key
        self.mac=mac
    ...
    def getDataSeries(self,mac,ch,timefrom=None,timeto=None):
        ...
        while ahead:
            ...
            u = DataFrame(serialize_object(self._gch(self.key,self.mac,mac,ch,timefrom,timeto)))
